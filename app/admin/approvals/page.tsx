...
import { formatCurrency, readJsonSafe, toDateTimeLocalInput, fromDateTimeLocalInput, formatDateTime } from '@/lib/formatters';
  ...
  const fetchPending = useCallback(async (query?: string, filter?: 'PENDING' | 'ALL') => {
    ...
    try {
      ...
      if (useFilter === 'PENDING') {
        qb = qb.in('status', ['PENDING', 'PENDING_APPROVAL']);
      }
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-wrap items-start justify-between gap-4 mb-4">
                    <div>
                      <div className="flex items-center gap-3 flex-wrap">
                        ...
                        {(req.status === 'PENDING' || req.status === 'PENDING_APPROVAL') && <span className="badge-pending">● PENDING APPROVAL</span>}
                  ...
                  <div className="flex gap-3 flex-wrap items-center">
                    ...
                    {(req.status === 'PENDING' || req.status === 'PENDING_APPROVAL') && approvingId !== req.id && (
                      <>
                        <button
