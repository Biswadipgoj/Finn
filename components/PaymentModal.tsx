  ...
  return (
    <div className="modal-backdrop" onClick={e => e.target === e.currentTarget && onClose()}>
      <div className="modal-panel flex flex-col">
        ...
        <div className="flex-1 min-h-0 p-4 space-y-4 overflow-y-auto pb-28 sm:pb-4">
        ...
        <div className="shrink-0 sticky bottom-0 z-20 bg-white border-t border-surface-4 p-3 flex gap-3 safe-bottom">
